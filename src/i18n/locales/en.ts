export default {
  translation: {
    ...
    // HiveRelay video rooms
    'Video Rooms': 'Video Rooms',
    'Video Room': 'Video Room',
    'Login with your Nostr key to create and join video rooms.': 'Login with your Nostr key to create and join video rooms.',
    'Subscription active': 'Subscription active',
    'No active subscription': 'No active subscription',
    'Subscribe to create and own rooms.': 'Subscribe to create and own rooms.',
    'Plan: {{plan}}': 'Plan: {{plan}}',
    Subscribe: 'Subscribe',
    'Create a room': 'Create a room',
    'Register a permanent room you own.': 'Register a permanent room you own.',
    'Requires an active subscription.': 'Requires an active subscription.',
    'Create room': 'Create room',
    'Join a room': 'Join a room',
    'Enter a room name to join': 'Enter a room name to join',
    'Join now': 'Join now',
    'Room name': 'Room name',
    'Your rooms': 'Your rooms',
    'You have not created any rooms yet.': 'You have not created any rooms yet.',
    'Live now': 'Live now',
    'No live rooms right now.': 'No live rooms right now.',
    Public: 'Public',
    Private: 'Private',
    'Audience mode': 'Audience mode',
    'Go back': 'Go back',
    'Connection lost. Please rejoin from the Video Rooms page.': 'Connection lost. Please rejoin from the Video Rooms page.',
    'Failed to connect to the room.': 'Failed to connect to the room.',
    'Failed to join room': 'Failed to join room',
    'Choose a plan': 'Choose a plan',
    'Pay with Lightning': 'Pay with Lightning',
    'Scan or paste this invoice in your Lightning wallet': 'Scan or paste this invoice in your Lightning wallet',
    'Waiting for payment...': 'Waiting for payment...',
    'Payment settled!': 'Payment settled!',
    'Payment expired': 'Payment expired',
    'Payment failed': 'Payment failed',
    '{{days}} days · {{rooms}} rooms · {{sats}} sats': '{{days}} days · {{rooms}} rooms · {{sats}} sats',
    'Room name must be 3-64 characters': 'Room name must be 3-64 characters',
    'Room name can only contain letters, digits, hyphens and underscores': 'Room name can only contain letters, digits, hyphens and underscores',
